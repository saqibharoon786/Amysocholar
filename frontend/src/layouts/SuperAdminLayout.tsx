...
const SuperAdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: "Book Categories", href: "/superadmin/categories", icon: FolderPlus },
    { name: "Judgment Categories", href: "/superadmin/judgment-categories", icon: Gavel },
    { name: "Upload Book", href: "/superadmin/upload", icon: Upload },
    { name: "Upload Judgment", href: "/superadmin/upload-judgment", icon: Scale },
